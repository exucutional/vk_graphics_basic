...
// Ќа моем пк следующий диапазон значений
//Vulkan
//-> Result : -1.93579e-05
...
// –еализаци€ с использованием вулкана примерно в 3 раза быстрее чем на cpu.
// Ќепосредственно врем€ исполнени€ обычного шейдера и шейдера с shared пам€тью довольно сильно скачет.
// ќт запуска к запуску ускорение shared шейдера варьируетс€ от 1.2 до 3.
// ¬ среднем ускорение shared шейдера 1.7
int main()
{
  vulkan_run();
  cpu_run();
